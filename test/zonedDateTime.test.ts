...
describe("zonedDateTime", () => {
    ...
    describe("min", () => {
        ...
        it("should fail when value is before the min boundary", () => {
            ...
            expectError(
                schema,
                "2020-12-31T23:59:59+00:00[UTC]",
                "temporal.zonedDateTime.min",
            );
        });
    ...
    describe("timezone", () => {
        ...
        it("should fail when timezone does not match", () => {
            ...
            const error = expectError(
                schema,
                "2021-06-15T12:00:00+02:00[Europe/Berlin]",
                "temporal.zonedDateTime.timezone",
            );
